...
<script setup>
	...
	import gerryImage from '@/assets/images/gerry.png';
	...
	import simpleviaImage from '@/assets/images/simplevia.png';
	import icicctImage from '@/assets/images/icicct.png';
	...
	import awsCloud from '@/assets/images/awsCloud.png';
	import fcgesImage from '@/assets/images/fcgeslogo.png';
	...
	const timelineItems = ref([
		...
		},
		{
			...
			labels: ['career', 'job'],
			description:
				'Integrating backend systems at FCGES to streamline subscriptions and purchases for product access.',
			image: fcgesImage,
		},
	]);
