...
<script setup>
	...
	const technologies = [
		{
			name: 'Vue.js',
			logo: new URL('@/assets/icons/vue.svg', import.meta.url).href,
		},
		{
			name: 'Laravel',
			logo: new URL('@/assets/icons/laravel.svg', import.meta.url).href,
		},
		{
			name: 'Tailwind',
			logo: new URL('@/assets/icons/tailwind.svg', import.meta.url).href,
		},
		{
			name: 'Figma',
			logo: new URL('@/assets/icons/figma.svg', import.meta.url).href,
		},
		{
			name: 'GitHub',
			logo: new URL('@/assets/icons/git.svg', import.meta.url).href,
		},
		{
			name: 'Adobe',
			logo: new URL('@/assets/icons/adobe.svg', import.meta.url).href,
		},
		{
			name: 'MongoDB',
			logo: new URL('@/assets/icons/mongodb.svg', import.meta.url).href,
		},
		{
			name: 'Pinia',
			logo: new URL('@/assets/icons/pinia.svg', import.meta.url).href,
		},
	];
