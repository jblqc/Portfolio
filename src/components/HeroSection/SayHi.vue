  ...
  <section class="contact-card" :class="{ 'contact-card-dark': isDarkMode }">
    <v-container>
      <v-row align="center" class="d-flex flex-column-reverse flex-md-row">
        <!-- Left Section -->
        <v-col class="text-left flex-column">
          <Text
            :text="'Say hi!'"
            variant="display-4"
            fontWeight="bold"
          ...
          />
          <div class="mt-2 mb-5 contact-links">
            <svg
            ...
            >
              <defs>
                <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%">
                  ...
                  <stop offset="100%" stop-color="#DE00FF" />
                </linearGradient>
              </defs>
              <path
            ...
            <Text
              ...
              fontWeight="500"
              :gradient="'linear-gradient(90deg, #5b7fff, #f44f8a)'"
              class="tracking-wider ml-2"
            />
          </div>
                  <div class="mb-6">

            <Text
              :text="'Want to create something awesome? Or, do you have any query? Drop an email.'"
              variant="headline"
              fontWeight="400"
            ...
            <router-link to="/inquiry">
              <v-btn class="gradient-btn px-6 py-2 rounded-pill shadow-lg">
                Send Inquiry
              </v-btn>
            </router-link>
        </v-col>
...
.contact-card-dark {
  background: linear-gradient(
    122deg,
    rgba(94, 21, 67, 0.584) 10%,
    rgba(164, 76, 184, 0.777) 45%,
    rgba(60, 150, 254, 0.459) 100%
  );
